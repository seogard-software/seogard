...
useSeoMeta({
  ...
  description: 'Prévisualisez les templates d\'email envoyés par Seogard : rapport de crawl, estimation, facturation.',
})

const templates = [
  { id: 'welcome', label: 'Bienvenue' },
  { id: 'crawl-report', label: 'Rapport de crawl (régressions + réparations)' },
