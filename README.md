...
- **60+ SEO, GEO & performance rules** — meta tags, canonical, noindex, redirects, structured data, headings, content, AI readiness (llms.txt, robots.txt AI crawlers like GPTBot/ClaudeBot/PerplexityBot)
